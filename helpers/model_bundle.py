...
def build_t4d_model_bundle( 
    *,
    ...
    feature_mean = None,
    feature_scale = None,
    air_water_model = None,
    air_water_feature_cols = None,
    air_water_fill_values = None,
    air_water_station_context = None,
    response_targets = None,
    response_model_store = None,
    response_feature_store = None,
    response_fill_store = None,
    response_station_context = None,
):
    return { 
        ...
        'rolling_regime_classifier': { 
            'regime_feature_cols': list( regime_feature_cols ) if regime_feature_cols is not None else None,
            'centroids_z': centroids_z,
            'feature_mean': feature_mean,
            'feature_scale': feature_scale,
        },
        'air_to_water_temperature_model': { 
            'selected_model': air_water_model,
            'selected_features': list( air_water_feature_cols ) if air_water_feature_cols is not None else None,
            'selected_fill_values': air_water_fill_values,
            'context_table': air_water_station_context,
        },
        'response_signature_models': { 
            'targets': list( response_targets ) if response_targets is not None else None,
            'model_store': response_model_store,
            'feature_store': response_feature_store,
            'fill_store': response_fill_store,
            'station_context': response_station_context,
        },
    }
